    ...
    public partial class Catalog : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                {
                    if (product.isRemoved.Equals("false"))
                    {
                        numItems += 1;
                    }
                }
                ...
                foreach (var product in lh.getAllProducts())
                {
                    if (product.isRemoved.Equals("false"))
                    {
                        ...
                        if (Session["Id"] != null && authentication.Equals("C"))
                        {
                        ...
                        else if (Session["Id"] != null && authentication.Equals("M"))
                        {
                            htmlText += "<div class='item_add'><span class='item_price'><a href ='EditProduct.aspx?producttypeId=" + product.ProductId + "'>Edit item</a></span></div>";

                            htmlText += "<div class='item_add'><span class='item_price'><a href ='RemoveProduct.aspx?producttypeId=" + product.ProductId + "'>Remove item</a></span></div>";
                        }
